...
public class Constants {
	...
	public static String SERVER1 = "srv-px3";
	public static String SERVER2 = "srv-px4";
	public static String CT_BASE_NAME = "ct-tpgei-ctlv-A17-ct";
	public static long CT_BASE_ID = 11700;
	...
	public static long MONITOR_PERIOD = 1;
